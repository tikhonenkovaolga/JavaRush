...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        List<int[][]> leftRight = new ArrayList<>(2);
        leftRight.add(ShapeMatrix.FIRE_SIDE_1);
        leftRight.add(ShapeMatrix.FIRE_SIDE_2);
        leftFire = new RocketFire(leftRight);
        rightFire = new RocketFire(leftRight);
    }
