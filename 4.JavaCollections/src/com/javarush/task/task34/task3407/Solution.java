...
public class Solution {
    ...
    public static class Helper {
        ...
        public List<PhantomReference<Monkey>> getPopulatedList() {
            List<PhantomReference<Monkey>> phantomMonkey = new ArrayList<>();
            for (int i = 0; i < 200; i++){
                PhantomReference<Monkey> phantomReference = new PhantomReference<Monkey>(new Monkey(), helper.getQueue());
                phantomMonkey.add(phantomReference);
            }



            return phantomMonkey;
        }
